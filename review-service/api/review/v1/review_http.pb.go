...
const OperationReviewGetReviewByOrderID = "/api.review.v1.Review/GetReviewByOrderID"
const OperationReviewGetReviewReplyList = "/api.review.v1.Review/GetReviewReplyList"
...
func RegisterReviewHTTPServer(s *http.Server, srv ReviewHTTPServer) {
	...
	r.POST("/v1/appeal", _Review_AppealReview0_HTTP_Handler(srv))
	r.POST("/v1/reply", _Review_ReplyReview0_HTTP_Handler(srv))
	r.GET("/v1/review/order/{orderID}", _Review_GetReviewByOrderID0_HTTP_Handler(srv))
	...
	r.GET("/v1/review/reply/{reviewID}", _Review_GetReviewReplyList0_HTTP_Handler(srv))
...
func _Review_GetReviewByOrderID0_HTTP_Handler(srv ReviewHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GetReviewByOrderIDRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		...
		http.SetOperation(ctx, OperationReviewGetReviewByOrderID)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetReviewByOrderID(ctx, req.(*GetReviewByOrderIDRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*GetReviewByOrderIDReply)
		return ctx.Result(200, reply)
	}
}
...
func _Review_GetReviewReplyList0_HTTP_Handler(srv ReviewHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationReviewGetReviewReplyList)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetReviewReplyList(ctx, req.(*GetReviewReplyRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*GetReviewReplyReply)
		return ctx.Result(200, reply)
	}
}
...
type ReviewHTTPClient interface {
	...
	GetReviewByOrderID(ctx context.Context, req *GetReviewByOrderIDRequest, opts ...http.CallOption) (rsp *GetReviewByOrderIDReply, err error)
	GetReviewReplyList(ctx context.Context, req *GetReviewReplyRequest, opts ...http.CallOption) (rsp *GetReviewReplyReply, err error)
...
func (c *ReviewHTTPClientImpl) GetReviewByOrderID(ctx context.Context, in *GetReviewByOrderIDRequest, opts ...http.CallOption) (*GetReviewByOrderIDReply, error) {
	var out GetReviewByOrderIDReply
	pattern := "/v1/review/order/{orderID}"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationReviewGetReviewByOrderID))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *ReviewHTTPClientImpl) GetReviewReplyList(ctx context.Context, in *GetReviewReplyRequest, opts ...http.CallOption) (*GetReviewReplyReply, error) {
	var out GetReviewReplyReply
	pattern := "/v1/review/reply/{reviewID}"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationReviewGetReviewReplyList))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
