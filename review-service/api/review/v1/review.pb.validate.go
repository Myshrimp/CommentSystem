...
// Validate checks the field values on GetReviewByOrderIDRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetReviewByOrderIDRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetReviewByOrderIDRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetReviewByOrderIDRequestMultiError, or nil if none found.
func (m *GetReviewByOrderIDRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetReviewByOrderIDRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetReviewByOrderIDRequestMultiError(errors)
	}

	return nil
}

// GetReviewByOrderIDRequestMultiError is an error wrapping multiple validation
// errors returned by GetReviewByOrderIDRequest.ValidateAll() if the
// designated constraints aren't met.
type GetReviewByOrderIDRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetReviewByOrderIDRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetReviewByOrderIDRequestMultiError) AllErrors() []error { return m }

// GetReviewByOrderIDRequestValidationError is the validation error returned by
// GetReviewByOrderIDRequest.Validate if the designated constraints aren't met.
type GetReviewByOrderIDRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetReviewByOrderIDRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetReviewByOrderIDRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetReviewByOrderIDRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetReviewByOrderIDRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetReviewByOrderIDRequestValidationError) ErrorName() string {
	return "GetReviewByOrderIDRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetReviewByOrderIDRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetReviewByOrderIDRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetReviewByOrderIDRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetReviewByOrderIDRequestValidationError{}

// Validate checks the field values on GetReviewByOrderIDReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetReviewByOrderIDReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetReviewByOrderIDReply with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetReviewByOrderIDReplyMultiError, or nil if none found.
func (m *GetReviewByOrderIDReply) ValidateAll() error {
	return m.validate(true)
}

func (m *GetReviewByOrderIDReply) validate(all bool) error {
	if m == nil {
		return nil
	}
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GetReviewByOrderIDReplyValidationError{
			...
			if err := v.Validate(); err != nil {
				return GetReviewByOrderIDReplyValidationError{
					field:  fmt.Sprintf("Reviews[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return GetReviewByOrderIDReplyMultiError(errors)
	}

	return nil
}

// GetReviewByOrderIDReplyMultiError is an error wrapping multiple validation
// errors returned by GetReviewByOrderIDReply.ValidateAll() if the designated
// constraints aren't met.
type GetReviewByOrderIDReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetReviewByOrderIDReplyMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetReviewByOrderIDReplyMultiError) AllErrors() []error { return m }

// GetReviewByOrderIDReplyValidationError is the validation error returned by
// GetReviewByOrderIDReply.Validate if the designated constraints aren't met.
type GetReviewByOrderIDReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetReviewByOrderIDReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetReviewByOrderIDReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetReviewByOrderIDReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetReviewByOrderIDReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetReviewByOrderIDReplyValidationError) ErrorName() string {
	return "GetReviewByOrderIDReplyValidationError"
}

// Error satisfies the builtin error interface
func (e GetReviewByOrderIDReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetReviewByOrderIDReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetReviewByOrderIDReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetReviewByOrderIDReplyValidationError{}
...
// Validate checks the field values on GetReviewReplyRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetReviewReplyRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetReviewReplyRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetReviewReplyRequestMultiError, or nil if none found.
func (m *GetReviewReplyRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetReviewReplyRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetReviewReplyRequestMultiError(errors)
	}

	return nil
}

// GetReviewReplyRequestMultiError is an error wrapping multiple validation
// errors returned by GetReviewReplyRequest.ValidateAll() if the designated
// constraints aren't met.
type GetReviewReplyRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetReviewReplyRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetReviewReplyRequestMultiError) AllErrors() []error { return m }

// GetReviewReplyRequestValidationError is the validation error returned by
// GetReviewReplyRequest.Validate if the designated constraints aren't met.
type GetReviewReplyRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetReviewReplyRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetReviewReplyRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetReviewReplyRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetReviewReplyRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetReviewReplyRequestValidationError) ErrorName() string {
	return "GetReviewReplyRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetReviewReplyRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetReviewReplyRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetReviewReplyRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetReviewReplyRequestValidationError{}

// Validate checks the field values on GetReviewReplyReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetReviewReplyReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetReviewReplyReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetReviewReplyReplyMultiError, or nil if none found.
func (m *GetReviewReplyReply) ValidateAll() error {
	return m.validate(true)
}

func (m *GetReviewReplyReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetReplyList() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GetReviewReplyReplyValidationError{
						field:  fmt.Sprintf("ReplyList[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
			...
			if err := v.Validate(); err != nil {
				return GetReviewReplyReplyValidationError{
					field:  fmt.Sprintf("ReplyList[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return GetReviewReplyReplyMultiError(errors)
	}

	return nil
}

// GetReviewReplyReplyMultiError is an error wrapping multiple validation
// errors returned by GetReviewReplyReply.ValidateAll() if the designated
// constraints aren't met.
type GetReviewReplyReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetReviewReplyReplyMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetReviewReplyReplyMultiError) AllErrors() []error { return m }

// GetReviewReplyReplyValidationError is the validation error returned by
// GetReviewReplyReply.Validate if the designated constraints aren't met.
type GetReviewReplyReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetReviewReplyReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetReviewReplyReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetReviewReplyReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetReviewReplyReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetReviewReplyReplyValidationError) ErrorName() string {
	return "GetReviewReplyReplyValidationError"
}

// Error satisfies the builtin error interface
func (e GetReviewReplyReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetReviewReplyReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetReviewReplyReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetReviewReplyReplyValidationError{}
