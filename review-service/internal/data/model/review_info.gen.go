...
type ReviewInfo struct {
	...
	IsDel        int32      `gorm:"column:is_del;not null;comment:是否删除:0否;1是" json:"is_del"`                           // 是否删除:0否;1是
	...
	*/
	...
	HasReply       int32  `gorm:"column:has_reply;not null;comment:是否有商家回复:0⽆;1有" json:"has_reply"`      // 是否有商家回复:0⽆;1有
