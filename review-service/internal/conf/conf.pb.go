...
func (x *Snowflake) GetNodeId() int64 {
	if x != nil {
		return x.NodeId
	}
	return 0
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"C\n" +
	"\tSnowflake\x12\x1d\n" +
	"\n" +
	"start_time\x18\x01 \x01(\tR\tstartTime\x12\x17\n" +
	"\anode_id\x18\x02 \x01(\x03R\x06nodeIdB#Z!review-service/internal/conf;confb\x06proto3"
